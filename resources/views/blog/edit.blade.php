...
<div class="w-4/5 m-auto pt-1 ">
    ...
    <form action="/blog/{{$post->slug}}" method="POST" enctype="multipart/form-data">
        ...
        <label class="block pt-4">
            ...
            <input class="form-input mt-1 block w-90 " value="{{$post->title}}"  name="title">
          </label>

          <label class="block pt-4">
            <span class="text-gray-700 pb-1">Descripcion</span>
            <textarea class="form-textarea mt-1 block w-full" rows="3" placeholder="Ingrese el  content." name="description">{{$post->description}}</textarea>
          </label>
